...
<head>
	...
	<title>Signup Transportation-Provider</title>
	<!-- core:css -->
...
<body>
			...
			<div class="page-content d-flex align-items-center justify-content-center">
                ...
                <div class="col-md-12 pl-md-0">
                  <div class="auth-form-wrapper px-4 py-5">
                    ...
                    <h5 class="text-muted font-weight-normal mb-4">Signup Transportation-Provider</h5>
                    <form id="signup-driver" method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
  ...
  <script src="js/signup-driver.js"></script>
	<!-- endinject -->

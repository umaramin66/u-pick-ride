...
<head>
  ...
  <title>U Pick Ride || Brands</title>
  <!-- core:css -->
      ...
      <div class="page-content">
        ...
        <div class="row">
          <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <h6 class="card-title text-muted">Brand Register with Us</h6>
                  ...
                  <table id="dataTableExample" class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>Ashton Cox</td>
                        <td class="text-danger">Not in use</td>
                        <td>0</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td class="text-danger">Not in us</td>
                        <td>6</td>
                      </tr>
                      <tr>

                ...
                <form id="add-driver" method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        <div class="form-group">
                          ...
                          <input type="text"  name="name" id="name" class="form-control" value="<?=$data['name']?>" placeholder="Enter name" readonly>
                        </div>
                      </div>
                    <div class="col-sm-12">
                        <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                          ...
                          <input type="text"  name="address" id="address" class="form-control"value="<?=$data['address']?>"placeholder="Enter Address" readonly>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="form-group">
                          <label class="control-label">Phone No</label>
                          <input type="text"  name="phone_number" id="phone_number" class="form-control"value="<?=$data['phone_number']?>" placeholder="Enter Phone" readonly>
                        </div>
                    </div>

        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a href="drivers.php" class="nav-link">
              ...
              <span class="link-title">Transportation Providers</span>
            </a>
          </li>
          <!-- <li class="nav-item">
            <a href="drivers.php" class="nav-link">
              <i class="link-icon" data-feather="inbox"></i>
              <span class="link-title">Add Transportation Provider</span>
            </a>
          </li> -->
          <li class="nav-item">
            <a href="create-driver.php" class="nav-link">
              <i class="link-icon" data-feather="grid"></i>
              <span class="link-title">Create Driver</span>
            </a>
          </li>
          ...
          <li class="nav-item">
            <a href="image-content.php" class="nav-link">
              <i class="link-icon" data-feather="image"></i>
              <span class="link-title">Image Content</span>
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a href="send-message-driver.php" class="nav-link">
